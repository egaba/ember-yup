...
return this.get("integer")&&(c=c.integer(i)),this.get("positive")?c=c.positive(o):this.get("negative")&&(c=c.negative(s)),this.get("min")&&(c=c.min(this.get("min"),a)),this.get("max")&&(c=c.max(this.get("max"),u)),this.get("required")&&(c=c.required(t)),c}),registerField:Ember.on("didInsertElement",function(){this.get("form")&&this.set("form.fieldMap."+this.elementId,this)}),unregisterField:Ember.on("willDestroyElement",function(){this.get("form")&&this.set("form.fieldMap."+this.elementId,void 0)}),didBlur:!1,errorMessage:"",validate:Ember.observer("value","didBlur",function(){var e=this
if(this.get("didBlur")){var t=this.get("schema").validate(this.get("value")).then(function(t){return e.onInput&&e.onInput(t),e.get("name")?function(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}({},e.get("name"),t):t})
return t.then(function(){e.set("errorMessage","")}).catch(function(t){e.set("errorMessage",t.message)}),t}})})})
...
s.set("didBlur",!0),i.push(s.validate())}Ember.RSVP.allSettled(i).then(function(e){if(Ember.A(e).isAny("state","rejected"))t.onReject(e.mapBy("reason"))
