...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({schema:null,value:"",enabled:!1,schemaErrors:[],errors:Ember.computed("schemaErrors.[]",function(){return this.get("schemaErrors")}),validation:Ember.computed("value","schema",function(){var e=this,t=this.get("schema")
return t?t.validate(this.get("value")).then(function(t){e.get("name")
return e.set("schemaErrors",[]),e.onInput&&e.onInput(t),t}).catch(function(t){return e.set("schemaErrors",t.errors),t.errors}):null}),validate:Ember.on("init",Ember.observer("validation","enabled",function(){if(this.get("enabled"))return this.get("validation")})),form:null,name:null,registerFieldToForm:Ember.on("didInsertElement",function(){var e=this.get("form"),t=this.get("name")
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=t.default.extend({layout:r.default,validationMessages:{dataType:void 0,email:void 0,url:void 0,type:void 0,required:void 0,charLimit:"this exceeds the character limit"},errors:Ember.computed("schemaErrors.[]","charLimitErrors.[]",function(){return this.get("schemaErrors").concat(this.get("charLimitErrors"))}),type:"string",required:!1,schema:Ember.computed("validationMessages.dataType","type","validationMessages.email","validationMessages.url","validationMessages.type","required","validationMessages.required",function(){var e=this.get("type"),t=n.string(this.get("validationMessages.dataType"))
...
return e>0?n.number().positive().integer().max(e,this.get("validationMessages.charLimit")):null}),charRemaining:Ember.computed("value","charLimit",function(){var e=this.get("charLimit")
